...
\begin{frame}{Questions}
  \begin{itemize}
  \item \textbf{\alert{Why}} are certain kinds of self-doubt irrational? Why is some amount of self-trust rationally
    required?
  \item \alert{\textbf{How much}} may we rationally doubt ourselves? What is the minimum amount of self-trust that is
    rationally required?
...
\begin{frame}{Many open questions...}
  \begin{itemize}
  \item Is it really bad to expect some possibly incoherent definite description to be more accurate than you, when you are \textit{certain} to be coherent?
    I.e. is there any epistemic value to normative certainty?
  \item How do we determine which doxastic states we should compare your own with when evaluating you?
  \item What can we say about self-trust for imprecise doxastic states?
  \end{itemize}
